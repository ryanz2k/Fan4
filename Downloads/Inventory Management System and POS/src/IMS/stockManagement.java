...
public class stockManagement extends javax.swing.JFrame {
   ...
   /**
    ...
    private void initComponents() {
        ...
        backupButton.setBounds(40, 470, 200, 39);
        ...
        jPanel1.add(budget);
        budget.setBounds(430, 460, 150, 70);
        ...
        budgetLabel.setBounds(250, 460, 190, 70);
        ...
        importData1.setBounds(540, 470, 220, 39);
        ...
        clearTable.setBounds(40, 520, 260, 39);
    ...
    private void productListActionPerformed(java.awt.event.ActionEvent evt) {                                            
        // TODO add your handling code here:
    ...
    private void importData1ActionPerformed(java.awt.event.ActionEvent evt) {                                            
        if (canImport == true)
        {
            String filepath = "data.txt";
            File file = new File(filepath);
